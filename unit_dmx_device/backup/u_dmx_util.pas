...
begin
  if aImage.ClientWidth > aImage.ClientHeight then
    ima := SVGFileToBGRABitmap(FixtureSVGFileFor(aFT), -1, aImage.ClientHeight)
  else
    ima := SVGFileToBGRABitmap(FixtureSVGFileFor(aFT), aImage.ClientWidth, -1);
  bmp := TBitmap.Create;
...
begin
  ...
  case aCT of
    ctCONFIG: Result:=Result+'CursorConfig.png';
    ctMASTERDIMMER: Result:=Result+'CursorMasterDimmer.png';
    ctDIMMER: Result:=Result+'CursorDefault.png';
    ctRED: Result:=Result+'CursorRed.png';
    ctGREEN: Result:=Result+'CursorGreen.png';
    ctBLUE: Result:=Result+'CursorBlue.png';
    ctSTROBE: Result:=Result+'CursorStrobe.png';
    ctPAN: Result:=Result+'CursorPan.png';
    ctTILT: Result:=Result+'CursorTilt.png';
    ctPANTILTSPEED: Result:=Result+'CursorSpeedPanTilt.png';
    ctGOBO: Result:=Result+'CursorGobo.png';
    ctGOBOROTATION: Result:=Result+'CursorGoboRotation.png';
    ctCOLORCHOICE: Result:=Result+'CursorColorChanger.png';
    ctWHITE: Result:=Result+'CursorWhite.png';
