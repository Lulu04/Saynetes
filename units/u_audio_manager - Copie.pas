...
begin
  ...
  i := ProgramOptions.PlaybackDeviceIndex-1;
  if i = -1 then
...
begin
  ...
  i := ProgramOptions.CaptureDeviceIndex-1;
  if i = -1 then
    FCaptureContext := ALSManager.CreateDefaultCaptureContext
  else begin
    FCaptureContext := ALSManager.CreateCaptureContext(i, 44100, ALS_CAPTUREFORMAT_STEREO16, 0.100);
  end;
