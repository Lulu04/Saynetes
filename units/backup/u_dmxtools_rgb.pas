...
begin
  ...
  begin
    Label19.Caption := FrameViewFixturesList1.Selected[0]._Name;
...
begin
  ...
  if Length(FTargetFixtures) > 1 then
    FShortReadable := FShortReadable + SMultiple
         ...
         else FShortReadable := FShortReadable + fix._Name;
...
begin
  ...
  if fixSource.Description <> '' then FShortReadable := FShortReadable + fixSource.Description
    else FShortReadable := FShortReadable + fixSource._Name;
  ...
  if Length(FTargetFixtures) > 2 then
    FShortReadable := FShortReadable + SMultiple
         ...
         else FShortReadable := FShortReadable + singleFix._Name;
  FDuration := 0.0;
end;
