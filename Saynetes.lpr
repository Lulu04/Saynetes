...
uses
  ...
  frame_editstring, frame_viewdmxcursors, u_dmxtools_channels, u_dmxtools_rgb,
  frame_viewuniverselist, frame_viewchannelslist, u_dmxtools_group,
  u_edit_otheraction, frame_fx_channelchaser, u_helper, u_add_action_audio,
  u_devicemanager_form, u_ftdi_based, ftd2xx, u_startupwizard,
  u_program_options, u_createplaylist, frame_viewcolorlist, frame_fx_rgbchaser,
  frame_viewfixtureslist, u_presetmanager, frame_viewfixtureinfo,
  u_askifshiftadress, u_project_manager, frame_viewdmxdipswitchs, u_logfile,
  frame_cmd_audiofx, frame_trackbar, u_datamodule, frame_audiolevels,
  frame_intermissionmusic, frame_audiocapture, frame_viewprojectfolder,
  frame_led, frame_buttononoff, u_add_action_dmx, frame_viewprojectors,
  u_global_var, frame_main_audio, frame_main_sequence, frame_main_addfixture,
  u_project_options, project_util, form_about, u_apputils,
  frame_viewfixtureimage, form_changefixtureimage, u_edit_singleaction,
  frame_viewfixtureoverview, frame_editmode, form_selectexistingchannel,
  form_definenewchannel, frame_cb_channeltype, form_editweblink,
  frame_viewmodeitem, form_definesvirtualchannel,
